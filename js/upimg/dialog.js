...
function windowsdig(title, content, width, height, cssName, isclose, iftype) {
    var temp_float = "<div id=\"floatBoxBg\"></div>";
    ...
    case "iframe":
        ...
        $("#dialogcontentlist").html("<iframe name=\"diglogfirameclass\" id=\"diglogfirameclass\" src=\"" + content + "\" width=\"100%\" height=\"475px" + (parseInt(height) - 30) + "px" + "\" scrolling=\"" + iftype + "\" frameborder=\"0\" marginheight=\"0\" marginwidth=\"0\"></iframe>")
    }
    $("#floatBoxBg").show();
    $("#floatBoxBg").animate({
        opacity: "0.4"
