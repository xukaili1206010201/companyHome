...
SWFUpload.prototype.uploadSuccess = function (file, serverData,des) {
	file = this.unescapeFilePostParams(file);
	des = this.settings.callback_data_des;
	this.queueEvent("upload_success_handler", [file, serverData,des]);
};
