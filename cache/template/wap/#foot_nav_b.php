...
<li class="themeStyle out" style="background:">
<a href="http://wpa.qq.com/msgrd?v=3&uin=<?php echo get('qq1');?>&site=qq&menu=yes" id="btn_fenxiang"><img src="<?php echo $skin_path;?>/images/wap/plugmenu5.png"><label><?php echo lang(qq);?></label></a>
</li>   
<li class="themeStyle out" style="background:">
