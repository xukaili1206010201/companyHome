...
foreach($fields as $f) { ?>
<tr>
<td class="s_out" align="center"><input onclick="c_chang(this)" type="checkbox" value="<?php echo $f['name'];?>" name="select[]" class="checkbox" /> </td>
<td align="center" class="catname"><?php echo $f['name'];?></td>
...
echo $s;
?></td>
<td align="center" class="htmldir"><?php echo $f['len'];?></td>
