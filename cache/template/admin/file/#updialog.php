...
var digheight="420";
var rootDIR="<?php echo config::get('base_url');?><?php if(substr(config::get('base_url'),-1,1)!='/'){echo '/';}?>";
...
piclistshow(filename,fileinputid,getbyid,iswidth);
}else if(checkfrom=='editwin'){
checkimageeditor(filename,fileinputid);
}
}
...
<div id="tabcontentdiv1" class="displaytrue"><iframe name="upfilewindow" class="upfilewindow" src="index.php?case=file&act=upfile" width="100%" height="485" scrolling="no" frameborder="0" marginheight="0" marginwidth="0"></iframe></div>
