...
<center>
    ...
    <input onclick="javascrtpt:window.location.href='<?php echo $base_url;?>/index.php?case=admin&act=login&admin_dir=<?php echo get(admin_dir);?>&site=default'" class="btn btn-primary" value=" 登陆网站后台 " />
</center>
