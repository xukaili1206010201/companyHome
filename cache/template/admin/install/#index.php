...
<style type="text/css">
.go {background:url(<?php echo $skin_path;?>/images/go_4.gif) center top no-repeat;}
</style>
<div class="result">
...
<center>
<input onclick="javascrtpt:window.location.href='<?php echo $base_url;?>/'" class="btn_b" style="margin-right:20px;" value=" 访问网站首页 " />
<input onclick="javascrtpt:window.location.href='<?php echo $base_url;?>/index.php?case=admin&act=login&admin_dir=<?php echo get(admin_dir);?>&site=default'" class="btn_a" value=" 登陆网站后台 " />
</center>
 <?php } else { ?>
<div class="table_box">
...
<style type="text/css">
.go {background:url(<?php echo $skin_path;?>/images/go_2.gif) center top no-repeat;}
</style>
...
<?php } ?>
<style type="text/css">
.go {background:url(<?php echo $skin_path;?>/images/go_3.gif) center top no-repeat;}
</style>
<tbody>
 <tr>
 ...
 <input type="checkbox" value="1" style="width:15px;height:15px;background:none;border:none;" name="createdb" <?php echo $input_disable;?>/>&nbsp;&nbsp;新建数据库&nbsp;&nbsp;<input type="checkbox" value="1" style="width:15px;height:15px;background:none;border:none;" name="testdata" <?php if(front::$post['database'] && !front::$post['testdata']) { ?>
 <?php } else { ?>
 checked
 <?php } ?> />&nbsp;&nbsp;安装初始数据
 </td>
