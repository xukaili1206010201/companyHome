...
<a href="<?php echo $base_url;?>/index.php?case=form&act=addform&admin_dir=<?php echo get('admin_dir');?>&site=default" class="btn btn-primary">添加表单</a>
...
foreach($tables as $t) { ?>
<tr>
<td class="s_out" align="center"><?php echo @setting::$var[$t]['myform']['cname'];?>&nbsp;
    (&nbsp;<font color="red"><?php  $_table=new defind($t); echo $_table->rec_count();?></font>&nbsp;)
</td>
<td class="catname" align="center"><?php echo $t;?></td>
<td class="manage" align="center">

<a  href="<?php echo url('form/add/form/'.$t,false);?>" target="_blank">预览</a>

<a href="<?php echo url('table/list/table/'.$t);?>">查看</a>
