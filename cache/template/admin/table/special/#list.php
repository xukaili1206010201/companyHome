...
<?php $spid=$d['spid']; ?>
<tr>
<td align="center" class="s_out"><input onclick="c_chang(this)" type="checkbox" value="<?php echo $spid;?>" name="select[]"></td>
<!--<td><?php echo form::input("listorder[$d[$primary_key]]",$d['listorder'],'size=3');?></td>-->
<td align="center" class="catid"><?php echo $d['spid'];?></td>
<td align="center" class="catname"><a href="<?php echo url("special/show/spid/$spid", false); ?>" target="_blank"><?php echo $d['title'];?></a></td>
