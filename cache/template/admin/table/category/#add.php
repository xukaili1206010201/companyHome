...
<script type="text/javascript" charset="utf-8" src="<?php echo $base_url;?>/ueditor.config.js"></script>
    <script type="text/javascript" charset="utf-8" src="<?php echo $base_url;?>/ueditor.all.js"> </script>
    <script type="text/javascript" charset="utf-8" src="<?php echo $base_url;?>/lang/zh-cn/zh-cn.js"></script>
    <script type="text/javascript" charset="utf-8" src="<?php echo $base_url;?>/addCustomizeButton.js"></script>
...
<div class="col-xs-8 col-sm-7 col-md-7 col-lg-5 text-left"><?php echo form::getform('parentid',$form,$field,$data);?>
...
<div class="col-xs-8 col-sm-7 col-md-7 col-lg-5 text-left">
<?php echo form::getform('isnav',$form,$field,$data);?>
...
<div class="col-xs-8 col-sm-7 col-md-7 col-lg-5 text-left"><?php echo form::getform('ismobilenav',$form,$field,$data);?>
<span class="tips" data-toggle="tooltip" data-html="ture" data-placement="left" title="是否在导航中显示栏目！"></span>
</div>
</div>
<div class="clearfix blank20"></div>
...
<div class="col-xs-8 col-sm-7 col-md-7 col-lg-5 text-left form-group has-error"><input name="htmlrule1" type="text" class="form-control" value="<?php echo $data['htmlrule'];?>" />
...
<div class="col-xs-8 col-sm-7 col-md-7 col-lg-5 text-left">
<td><?php echo form::getform('ecoding',$form,$field,$data,'class="form-control"');?>
