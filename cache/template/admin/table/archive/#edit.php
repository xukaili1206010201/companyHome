...
<div class="col-xs-8 col-sm-7 col-md-7 col-lg-5 text-left">
<input name="savehttppic" type="checkbox" value="1" />&nbsp;保存远程图片&nbsp;&nbsp;<input name="autothumb" type="checkbox" value="1" />&nbsp;第一张图片自动保存为缩略图
</div>
</div>
<div class="clearfix blank20"></div>
...
保存地址：
<span id="attachment_path_i"><?php echo archive_attachment(@$data['aid'],'path');?></span>
