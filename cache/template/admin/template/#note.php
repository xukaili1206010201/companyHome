...
foreach($tps as $tpl => $tp) { ?>
      ...
      <tr class="s_out">
          <td align="left" style="padding-left:10px;"><?php echo $_tp;?></td>
           <td align="left" style="padding-left:10px;">
           <input type="text" name="<?php echo $tpl;?>_name" class="form-control" value="<?php echo @help::$var['template_note'][$tpl.'_name'];?>">
           </td>
           <td align="left" style="padding-left:10px;">
           <input type="text" name="<?php echo $tpl;?>_note" class="form-control" value="<?php echo @help::$var['template_note'][$tpl.'_note'];?>">
           </td>
        </tr>
       <?php } ?>
