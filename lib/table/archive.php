    ...
    function getcols($act) {
        switch ($act) {
            case 'list':
                return '*';
            case 'modify':
                return 'aid,title,subtitle,catid,typeid,tag,spid,toppost,introduce,introduce_len,description,keyword,image,thumb,content,checked,template,showform,pics,linkto,mtitle,description,keyword,htmlrule,ishtml,attr1,attr2,attr3,adddate'.$this->mycols();
            case 'manage':
                return 'aid,title,username,catid,catid,spid,adddate,view,checked,linkto,content';
            case 'user_modify':
